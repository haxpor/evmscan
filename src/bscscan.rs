...
pub fn get_list_normal_transactions(ctx: &Context, address: &str) -> Result<Vec::<BSCNormalTransactionResponseSuccessVariantResult>, AppError>
{
    type ResultType = BSCNormalTransactionResponseSuccessVariantResult;
    type JsonType = BSCTransactionResponse::<ResultType>;

    get_list_transactions::<ResultType, JsonType>(ctx, BSCApiResponseType::NormalTransaction, address)
}
...
pub fn get_list_internal_transactions(ctx: &Context, address: &str) -> Result<Vec::<BSCInternalTransactionResponseSuccessVariantResult>, AppError>
{
    type ResultType = BSCInternalTransactionResponseSuccessVariantResult;
    type JsonType = BSCTransactionResponse::<ResultType>;

    get_list_transactions::<ResultType, JsonType>(ctx, BSCApiResponseType::InternalTransaction, address)
}
...
/// 10,000 transactions.
fn get_list_transactions<R, J>(ctx: &Context, api_req_type: BSCApiResponseType, address: &str) -> Result<Vec::<R>, AppError>
where
...
pub fn get_balance_address(ctx: &Context, address: &str) -> Result<U256, AppError> {
...
pub fn get_bep20_transfer_events_a(ctx: &Context, address: &str) -> Result<Vec::<BSCBep20TokenTransferEventResponseSuccessVariantResult>, AppError> {
